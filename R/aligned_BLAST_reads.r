#' Extract reads aligned in BLAST from corresponding FASTQ
#'
#' Compares fastq file with corresponding BLAST file to find reads that were found in BLAST search and writes to new file.

#' @useDynLib ssBLAST
#' @usage aligned_BLAST(fastq_file_path, BLAST_file_path, output_path = NULL)
